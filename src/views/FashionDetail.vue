<template>
  <div class="fashion-detail">
    ...
    <div class="container">
      ...
      <div class="row mt-3">
        <div class="col-md-6">
          <img :src="'../assets/images/' + product.gambar" class="img-fluid shadow" alt="Product Image" />
        </div>
        <div class="col-md-6">
          <h2>
          ...
          <form class="mt-4" v-on:submit.prevent>
            ...
            <div class="form-group">
              <label for="keterangan">Pesan Untuk Penjual</label>
              <textarea v-model="pesan.keterangan" class="form-control" placeholder="Tinggalkan Pesan"></textarea>
            </div>
      ...
      if (this.pesan.jumlah_pemesanan) {
        ...
        axios
          ...
          .then(() => {
            ...
            this.$toast.success('Barang Masuk Keranjang', {
              type: 'success',
              position: 'top-right',
              duration: 3000,
              dismissible: true,
        ...
        this.$toast.error('Lengkapi Pesanan!', {
          type: 'error',
          position: 'top-right',
          duration: 3000,
          dismissible: true,
