            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(keranjang, index) in keranjangs" :key="keranjang.id">
                  <th>{{ index + 1 }}</th>
                  <td><img :src="'../assets/images/' + products.gambar" class="img-fluid shadow" width="250" /></td>
                  <td>
        ...
        <div class="col-md-4">
          <form class="mt-4" v-on:submit.prevent>
            <div class="form-group">
              ...
              <input type="text" class="form-control" v-model="pesan.username" />
            </div>
            <div class="form-group">
  ...
  methods: {
    ...
    hapusKeranjang(id) {
      axios
        ...
        .then(() => {
          this.$toast.error('Berhasil menghapus keranjang', {
            type: 'error',
            position: 'top-right',
            duration: 3000,
            dismissible: true,
    ...
    checkout() {
      if (this.pesan.username && this.pesan.alamat){
